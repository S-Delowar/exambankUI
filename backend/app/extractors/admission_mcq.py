...
from ..schemas import AdmissionMcqPageExtraction, AdmissionMcqPdfExtraction
...
async def run(
    *,
    ...
    system_prompt, build_user_prompt = get_prompt(
        "admission_test", "mcq", subjects, subject_paper=None
    )
    ...
    for i, image_png in enumerate(images):
        ...
        page: AdmissionMcqPageExtraction = await extractor.extract_page(
            image_png=image_png,
            system_prompt=system_prompt,
            user_prompt=user_prompt,
            response_schema=AdmissionMcqPageExtraction,
            page_index=i,
        )
    ...
    return AdmissionMcqPdfExtraction(
