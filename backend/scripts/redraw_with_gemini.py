...
For every data/cropped_images/{paper}/page_<N>/image<M>.png, this writes:
    image<M>.redrawn.svg   ← Gemini's vector reconstruction
    image<M>.redrawn.png   ← high-DPI raster of the SVG

Usage:
    export GEMINI_API_KEY="your_key_here"
    python -m backend.scripts.redraw_with_gemini <paper_name>
